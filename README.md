...
src/
  ...
  components/
    ...
    quiz/                  the proving ground (단련 / 鍛錬 — folios run backwards into questions)
      ...
      QuizStage.jsx        the challenge → answer → feedback cycle (the script drill, generalized)
